  ...
  return (
    <div className="m-h-fit flex flex-1 max-w-3xl">
      <div className="p-10 h-full felx justify-center text-center font-titillium ">
        ...
        <h2 className="font-semibold m-5 mt-2">
          {' '}
        ...
        <div className="flex flex-col gap-12 py-8">
          <div className="flex flex-col gap-4 items-center">
            ...
            <p>
              Dive into the rich tapestry of the zodiac with detailed profiles
              of each sign. Explore your own sign, or learn more about the
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <p>
              ...
              zodiac signs. Discover your compatibility with friends, family,
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <p>
              Get a glimpse of what the stars have in store for you each week.
              Our weekly horoscopes provide guidance and insights tailored to
              your zodiac sign, helping you navigate life's twists and turns.
            </p>
          </div>
        </div>
      </div>
